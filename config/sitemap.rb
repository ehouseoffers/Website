...
SitemapGenerator::Sitemap.default_host = "http://www.ehouseoffers.com"
...
SitemapGenerator::Sitemap.add_links do |sitemap|
  ...
  sitemap.add '/about', :priority => 0.5, :changefreq => 'monthly'
  sitemap.add '/terms', :priority => 0.5, :changefreq => 'monthly'
  sitemap.add '/contact', :priority => 0.5, :changefreq => 'monthly'
