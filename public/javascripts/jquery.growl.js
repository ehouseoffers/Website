  ...
  $.Growl = {
    ...
    show: function(options){
      ...
      this._getContainer().prepend(
        '<div id="'+settings.id+'" class="growlstatus '+settings.cls+'" style="display:none;"><div id="growlicon"></div><div class="growlstatusclose"></div>'+settings.message+'</div>'
      );
      ...
      if(settings.icon!==false){
        ...
        $('#growlicon').addClass("growlicon_"+settings.icon);
      }
